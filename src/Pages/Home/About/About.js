            ...
            <div className="row">
                ...
                <div className="col-md-6 col-sm-12 my-5 pt-5 pb-5">
                    <div className="text-center">
                        ...
                        <p className="text-muted mt-3 p-2">There are no judgments here – No too much or not enough. No glares of disapproval. Here we keep open minds. We are nurturers. We seek only to encourage, empower and entertain. What we are is a diverse community; what we have is a culture of fun; what there is, is room for everyone: all kinds of people with all kinds of goals who’ve chosen to come reach them with us.</p>
                    </div>
                </div>
            </div>
        </div>
